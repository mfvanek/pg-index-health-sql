...
43. Tables with columns that reference PostgreSQL [large objects](https://www.postgresql.org/docs/current/largeobjects.html) stored in pg_largeobject (oid or [lo type](https://www.postgresql.org/docs/current/lo.html)) ([sql](https://github.com/mfvanek/pg-index-health-sql/blob/master/sql/tables_with_blob_columns.sql)).
