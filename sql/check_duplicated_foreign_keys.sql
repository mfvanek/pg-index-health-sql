    ...
    fk_with_attributes as (
        ...
        from pg_catalog.pg_constraint as c
            ...
            left join pg_catalog.pg_attribute as rel_att
                on rel_att.attrelid = c.conrelid
...
select
    r_from.relname as table_name,  -- referencing relation (renamed to table_name)
    c1.fk_name as constraint_name, -- name of the fk constraint (renamed to constraint_name)
    c2.fk_name as duplicate_constraint_name -- potential duplicate constraint name (renamed to duplicate_constraint_name)
from fk_with_attributes_grouped as c1
    inner join fk_with_attributes_grouped as c2
        on c1.fk_name < c2.fk_name
